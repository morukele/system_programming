...
const JMP_BUFFER_WIDTH: usize = mem::size_of::<usize>() * 8;
type jmp_buf = [i8; JMP_BUFFER_WIDTH];

static mut SHUT_DOWN: bool = false;
static mut RETURN_HERE: jmp_buf = [0; JMP_BUFFER_WIDTH];
...
fn ptr_to_jmp_buf() -> *mut i8 {
    unsafe {addr_of!(RETURN_HERE) as *const i8 as *mut i8}
}
